...
public class NewYearGIF_FirstActivity extends AppCompatActivity {

    CardView q_native, q_native_banner;

    LinearLayout startguide;
    private int admob;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adprogress = new Dialog(NewYearGIF_FirstActivity.this, R.style.Custom);
        ...
        startguide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (adsdata != null && adsdata.size() > 0) {
                    admob = 1;
                    if (adsdata.get(0).getCheckAdFirstInter().equals("admob")) {
                        adprogress.show();
                        admob_inter();
                    } else if (adsdata.get(0).getCheckAdFirstInter().equals("off")) {
                        Intent intent = new Intent(NewYearGIF_FirstActivity.this, MainActivity.class);
    ...
    private void Q_Native_banner() {
        ...
        q_native_banner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customTabsIntent.launchUrl(NewYearGIF_FirstActivity.this, Uri.parse(adsdata.get(0).getQurekaUrl()));
            }
        });
    }
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        if (mInterstitialAd != null) {
                            mInterstitialAd.show(NewYearGIF_FirstActivity.this);
                        }
                        ...
                        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                            ...
                            public void onAdDismissedFullScreenContent() {
                                ...
                                if (admob == 2) {
                                    Intent intent = new Intent(NewYearGIF_FirstActivity.this, NewYearGIF_TapToStartActivity.class);
                                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(intent);
                                }
                            }
...
//                            Log.i(TAG, loadAdError.getMessage());
    ...
    public void onBackPressed() {
        if (adsdata != null && adsdata.size() > 0) {
            admob = 2;
            if (adsdata.get(0).getCheckAdFirstBackpressInter().equals("admob")) {
                adprogress.show();
                admob_inter();
            } else if (adsdata.get(0).getCheckAdFirstBackpressInter().equals("off")) {
                Intent intent = new Intent(NewYearGIF_FirstActivity.this, NewYearGIF_TapToStartActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            } else {
